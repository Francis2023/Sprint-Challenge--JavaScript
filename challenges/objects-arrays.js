...
let unisWithUni = [];
unisWithUni = universities.filter(universities => universities.includes("Uni"))
...
lowCaseAnimalNames = zooAnimals.map(zooAnimals => zooAnimals.animal_name.toLowerCase())
...
populationTotal = zooAnimals.reduce(function(populationTotal,zooAnimals){ 
  return populationTotal + zooAnimals.population},0);
